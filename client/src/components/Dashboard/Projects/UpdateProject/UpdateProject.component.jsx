...
export default class UpdateProject extends Component {
    ...
    getProject = (id) => {
        axios.get(`/api/projects/${id}`).then(res => {
            this.setState({ project: res.data[0] }, () => {
                this.setState({ title: res.data[0]["title"], start_date: res.data[0].start_date.slice(0, 10), capacity: res.data[0]["capacity"], organization_name: res.data[0]["organization_name"], img_url: res.data[0]["img_url"], type: res.data[0]["type"], project_description: res.data[0]["project_description"] }, () => { console.log(this.state.start_date) });
    ...
    onMapClick = ({ lng, lat }) => {
        this.setState({ lng: lng, lat: lat }, () => { console.log(this.state.lat, this.state.lng) });
    };
    ...
    updateProject = (e) => {
        ...
        axios.put(`/api/projects/${this.state.id}`, projectData)
        ...
        return (
            <div className="admin-form">
                <form>
                    ...
                    <input type="file" accept="image/*" name="img_url" id="img_url" onChange={this.onChange} />
                    <br />
                    <br />
